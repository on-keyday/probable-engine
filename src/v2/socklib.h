...
namespace socklib {
    namespace v2 {
        ...
        std::shared_ptr<ServerRequestProxy<String, HttpHeader, String, Http2MapType, HpackTable>> accept_request() {
            return accept_request<String, HttpHeader, String, Http2MapType, HpackTable>();
        }
